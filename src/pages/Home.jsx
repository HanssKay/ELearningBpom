        ...
        <div className="flex justify-center w-full -z-10 md:h-screen h-200 bg-linear-to-b from-[var(--color-one)] to-[var(--color-two)]">
            <div className="md:flex flex-col-2 gap-32 md:top-0 top-25 relative items-center">
                <div className="flex flex-col ">
                    ...
                    <p className="md:mt-2 mt-2 md:text-xl text-xl text-justify md:px-0 px-10 md:text-start text-blue-950">Bergabunglah dengan program magang eksklusif kami dan dapatkan
                    ...
                    <button className="w-40 md:mt-5 mt-70 md:left-0 left-[120px] text-white font-bold md:relative absolute border-1 p-1 rounded-md bg-blue-500 hover:bg-blue-800">
                        <a href="/register">Daftar Sekarang</a>
                    </button>
                </div>
                <div className="flex ">
                    <img className=" md:h-[310px] h-60 md:ms-0 ms-10 md:mt-6 mt-[100px]" src={learn} alt="" />
                </div>
            </div>  
        </div>
        <Footer/>
